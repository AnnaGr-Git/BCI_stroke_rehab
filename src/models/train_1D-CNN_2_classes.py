...
modelname = CHANNEL_PAIRS + "/leave_subjects_out/test_physio_34_10_65_90_101/"+date+"_correctedBug/"
...
exclude =  [38, 88, 89, 92, 100, 104] + test_subjects
...
#Reshape for scaling
# x shape: num_trials x num_channels x num_datapoints
...
## Resample inbalanced classes
# sm = SMOTE(random_state=42)

# Resample to specific number
if CHANNEL_PAIRS == "ours_3_pairs":
    sampling_class_counts = {'L': 37080, 'R': 37080}
elif CHANNEL_PAIRS == "ours_6_pairs":
    sampling_class_counts = {'L': 68000, 'R': 68000}
else:
...
finalModelPath = os.path.join(save_path, 'finalModel.h5')
