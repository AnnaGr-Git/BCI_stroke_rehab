...
# DATA
data_path = "data/processed/physionet/2_classes/channel_pairs/"
source_path = os.path.join(root_path, data_path)

# SOURCE MODEL
# model_directory = "models/1D_CNN/ours_3_pairs/leave_subjects_out/test_physio_34_10_65_90_101/2023-03-31_11-48-20/"
model_directory = "models/1D_CNN/ours_3_pairs/leave_subjects_out/test_physio_34_10_65_90_101/2023-04-25_16-09-09_correctedBug/"

source_model_path = os.path.join(root_path, model_directory, "bestModel.h5")

# FINETUNED MODEL
model_save_path = os.path.join(root_path, "models/1D_CNN/ours_3_pairs/fine_tuned/physionet_base/")
try:
