...
class HopefullNet(tf.keras.Model):
    ...
    """
    def __init__(self, inp_shape = (640,2), two_class:bool=False):
        super(HopefullNet, self).__init__()
        self.inp_shape = inp_shape
        self.two_class = two_class

        #print(f"Input shape: {self.inp_shape}")
    ...
    def call(self, input_tensor):
        #print(f"Input shape: {np.shape(input_tensor)}")
